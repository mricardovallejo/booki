          ...
          {context?.aiProfileName && context.aiProfileId ? (
            <div className="mt-1 flex flex-wrap items-center gap-1">
              <Link
                ...
                title="This session's tutor profile — click to edit"
              ...
              >
                ...
                <span className="truncate">Tutor: {context.aiProfileName}</span>
              </Link>
              {context.readerProfileName && (
                ...
                >
                  ...
                  <span className="truncate">Reader: {context.readerProfileName}</span>
                </Link>
              )}
            </div>
          ) : (
